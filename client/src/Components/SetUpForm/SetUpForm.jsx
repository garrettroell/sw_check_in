  ...
  return (
    <Formik
      ...
      onSubmit={(values, actions) => {
        // first, send message to the user that the data is being sent to the server
    ...
    >
      {(props) => (
        ...
        >
          <Spacer h="15px" />
          <Field name="firstName" validate={validateRequiredField}>
            {({ field, form }) => (
              <FormControl
          ...
          <Spacer h="15px" />
          <Field name="lastName" validate={validateRequiredField}>
            {({ field, form }) => (
              <FormControl
          ...
          <Spacer h="15px" />
          <Field name="confirmationNumber" validate={validateRequiredField}>
            {({ field, form }) => (
              <FormControl
                isInvalid={
              ...
              >
                <FormLabel htmlFor="confirmationNumber" fontSize="sm" mb="0px">
                  Confirmation Number
                </FormLabel>
                <Input
                  {...field}
